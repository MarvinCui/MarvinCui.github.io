    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex gap-4 sm:gap-6 justify-center mt-6 sm:mt-8">
            <a href="/images/WeChatQRCode.jpeg"
               className="p-2 sm:p-3 glass-effect rounded-full hover:bg-pink-100/30 transition-all duration-300">
              <MessageCircleMore className="w-5 h-5 sm:w-6 sm:h-6 text-pink-700"/>
            </a>
            <a href="mailto:boran.cui@outlook.com"
               className="p-2 sm:p-3 glass-effect rounded-full hover:bg-purple-100/30 transition-all duration-300">
              <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-purple-700"/>
            </a>
            <a href="https://scholar.google.com/citations?user=pBg-RqEAAAAJ"
               className="p-2 sm:p-3 glass-effect rounded-full hover:bg-pink-100/30 transition-all duration-300">
              <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-pink-700"/>
            </a>
            <a href="https://x.com/Marvin_Cui"
               className="p-2 sm:p-3 glass-effect rounded-full hover:bg-pink-100/30 transition-all duration-300">
              <Twitter className="w-5 h-5 sm:w-6 sm:h-6 text-pink-700"/>
            </a>
            <a href="https://www.researchgate.net/profile/Boran-Cui"
               className="p-2 sm:p-3 glass-effect rounded-full hover:bg-pink-100/30 transition-all duration-300">
              <ScrollText className="w-5 h-5 sm:w-6 sm:h-6 text-pink-700"/>
            </a>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-2xl sm:max-w-4xl mx-auto">
          ...
          <div className="glass-panel p-8 sm:p-10 rounded-2xl space-y-4 sm:space-y-6 transform hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="glass-panel p-8 sm:p-10 rounded-2xl transform hover:scale-105 transition-all duration-300">
        <div className="flex flex-col sm:flex-row items-start gap-6 sm:gap-8">
          ...
          <div>
            ...
            <p className="text-purple-700 mt-1 mb-3 sm:mb-4">Co-Founder, Core Team Member</p>
            <p className="text-purple-800 leading-relaxed">
